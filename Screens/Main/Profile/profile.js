        ...
        <StyledView style={{backgroundColor:'white', flex: 1, }} insets={insets}>
                        ...
                        <View style={{ width:WIDTH, alignItems:'center' , paddingVertical: HEIGHT*0.02}}>
                            ...
                            {postedProperties != null ?
                                <PostedPropertyCard onPress={()=>navigation.navigate("PropertyDetail", {data: postedProperties, uid: userData._id})}>
                                    ...
                                    <PostedPropertyInfoContainer>
                                        ...
                                        <DatePriceText>
                                            {new Date(postedProperties.propertyInfo.availableFrom).toDateString().split(" ")[1]} {""}
                                            {new Date(postedProperties.propertyInfo.availableFrom).toDateString().split(" ")[2]} {""}
                                            {new Date(postedProperties.propertyInfo.availableFrom).toDateString().split(" ")[3]} {""}
                                            {" "} - {" "}
                                            {new Date(postedProperties.propertyInfo.availableTo).toDateString().split(" ")[1]} {""}
                                            {new Date(postedProperties.propertyInfo.availableTo).toDateString().split(" ")[2]} {""}
                                            {new Date(postedProperties.propertyInfo.availableTo).toDateString().split(" ")[3]} {""}
                            ...
                            :
                                ...
                                <Pressable style={{width:WIDTH, height:'100%', alignItems:'center', justifyContent:'center'}}
                                    ...
                                    <Lottie source={require('../../../subleaseProperties.json')} autoPlay loop={false} style={{width:WIDTH*0.6, height: WIDTH*0.6, }}/>
            ...
            <NoUserViewContainer>
                <View style={{width:WIDTH*0.6, height: WIDTH*0.6, }}>
                    <Lottie source={require('../../../notLoggedIn.json')} loop={false} style={{width:'100%', height: '100%' }}/>
                </View>
